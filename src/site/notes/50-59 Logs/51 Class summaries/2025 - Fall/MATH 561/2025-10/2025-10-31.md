---
{"dg-publish":true,"permalink":"/50-59-logs/51-class-summaries/2025-fall/math-561/2025-10/2025-10-31/","updated":"2025-11-02T19:34:41-08:00","dg-note-properties":{"last updated":"2025-11-02T19:34:41-08:00","topics":["Tensor algebras"],"date":"2025-10-31"}}
---

This following is a very brief summary of what happened in class on 2025-10-31.

After recapping our new algebraic structure, called an ... (ahem) ... [[40-49 Knowledge/41 Mathematics/Algebra theory/Algebras\|algebra]], we went on to construct a functor $\mathcal{T}:R\text{-{\bf Mod}}\to R\text{-{\bf Alg}}$ left adjoint to the forgetful functor $U:R\text{-{\bf Alg}}\to R\text{-{\bf Mod}}$. This functor is called the [[40-49 Knowledge/41 Mathematics/Algebra theory/Tensor algebras\|tensor algebra]] functor. To each $R$-module, $M$, it associates an $R$-algebra, $\mathcal{T}(M)$, defined by
