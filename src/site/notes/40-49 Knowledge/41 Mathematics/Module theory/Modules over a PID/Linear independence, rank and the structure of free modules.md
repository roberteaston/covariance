---
{"dg-publish":true,"permalink":"/40-49-knowledge/41-mathematics/module-theory/modules-over-a-pid/linear-independence-rank-and-the-structure-of-free-modules/","tags":["module_theory"],"updated":"2025-11-05T16:50:00-08:00","dg-note-properties":{"last updated":"2025-11-05T16:50:00-08:00","related":["[[40-49 Knowledge/41 Mathematics/Module theory/Modules over a PID/Noetherian modules]]","[[40-49 Knowledge/41 Mathematics/Module theory/Modules over a PID/Modules over a PID - The Fundamental Theorem]]"],"tags":["module_theory"]}}
---
...
Before we can determine the general structure of modules over a PID, we must first understand the structure of free modules over a PID. More specifically, we would like to understand the submodules of a free module and how bases for submodules relate to bases for the module.
...
We now apply the above property to the projection morphism $\pi_i:M\to R$, and so we see that $a_1$ divides $\pi_i(n_1)$ for each $i=1,\ldots, k$. Write $\pi_i(n_1)=a_1b_i$ for some $b_i\in R$ and define
