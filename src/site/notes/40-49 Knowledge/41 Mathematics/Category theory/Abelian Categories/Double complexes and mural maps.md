---
{"dg-publish":true,"permalink":"/40-49-knowledge/41-mathematics/category-theory/abelian-categories/double-complexes-and-mural-maps/","updated":"2024-03-06T14:01:59-08:00"}
---
...
$$\begin{align*}
H_m(X_{\bullet, n})&=\ker(\partial_{\text{out}}^{\text{vert}})/\operatorname{im}(\partial_{\text{in}}^{\text{vert}})\\
H_n(X_{m, \bullet})&=\ker(\partial_{\text{out}}^{\text{hor}})/\operatorname{im}(\partial_{\text{in}}^{\text{hor}})
\end{align*}$$
