...
The fact that the center construction is *not* functorial is a big hint that we're probably thinking about it "incorrectly." For a bit of insight into what is "really" going on, check out [this post](https://qchu.wordpress.com/2012/02/06/centers-2-categories-and-the-eckmann-hilton-argument/) by Qiaochu Yuan.
