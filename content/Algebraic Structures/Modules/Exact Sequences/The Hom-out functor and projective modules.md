---
last updated: 2023-10-27T10:30:15-07:00
related:
  - "[[Exact Sequences I - Illustrative examples]]"
  - "[[Exact Sequences II - Short and long exact sequences]]"
  - "[[Yoneda's Lemma]]"
---
In light of [[Yoneda's Lemma]], for any fixed object $r$ in a category $C$, understanding the object $r$ is equivalent to understanding the functor $\operatorname{Hom}_C(r,-):C\to \textbf{Set}$.
