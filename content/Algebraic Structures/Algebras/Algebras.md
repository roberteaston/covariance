...
4. More generally, if $M$ is an $R$-module then the [[Module morphisms and submodules#^5f0b4d|endomorphism ring]] $\operatorname{End}_R(M)$ is an $R$-algebra.
...
8. The [[Tensor algebras|tensor algebra]] $\mathcal{T}(M)$ of an $R$-module $M$ is an $R$-algebra.
9. The [[Symmetric algebras|symmetric algebra]] $\mathcal{S}(M)$ and [[Exterior algebras|exterior algebra]] $\bigwedge (M)$ of an $R$-module $M$ are both $R$-algebras.
