---
last updated: 2024-02-24T15:39:38-08:00
references:
...
This exactly says that $\det:\operatorname{GL}_n\Rightarrow \bullet^{\times}$ is a natural transformation between two functors $\textbf{CRing}\to \textbf{Grp}$.
^c9052c
